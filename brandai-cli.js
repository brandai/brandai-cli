...
var cli = meow({
  help: [
    ...
    '  $ brandai  <json|images|icons> --org <organization> --s <styleguide> --k <share key> --dest <destination folder> <dataType>',
    ...
    '  -org, --organization     Organization name of the style guide',
